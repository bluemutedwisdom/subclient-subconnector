...
public enum ApiMethod {
	...
	DELETE_PODCAST_EPISODE		(new Version(1, 9, 0), String.format(ApiMethod.REST_PREFIX, "deletePodcastEpisode.view")),
	DOWNLOAD_PODCAST_EPISODE	(new Version(1, 9, 0), String.format(ApiMethod.REST_PREFIX, "downloadPodcastEpisode.view")),
