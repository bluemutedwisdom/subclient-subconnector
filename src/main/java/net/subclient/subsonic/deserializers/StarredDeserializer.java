...
/**
 * This class specifies how to deserialize a {@link net.subclient.subsonic.mappings.Starred Starred} object.
 ...
 */
public class StarredDeserializer implements JsonDeserializer<Starred> {
	
	private Gson gson = new Gson();
	
	@Override
	public Starred deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
