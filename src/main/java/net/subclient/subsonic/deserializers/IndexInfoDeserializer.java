...
/**
 * This class specifies how to deserialize a {@link net.subclient.subsonic.mappings.IndexInfo IndexInfo} object.
 * It happens that the response could contain an object with name "artist" that is a JSON Array when it has more than one child, but it is a JSON Object when there is only one child.
 * <ul>
 * 		<li>
 * 			This is an example of an artist object with multiple childs.
 *		</li>
 * 			<pre>
 * 				{
 * 					artist : [
 ...
 * 			</pre>
 *		<li>
 *			This is an example of an artist object with just one child
 * 			<pre>
 * 				{
 * 					artist : {
 * 						//CHILD_ONE
 ...
 */
public class IndexInfoDeserializer implements JsonDeserializer<IndexInfo> {
	...
	public IndexInfo deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
		...
		indexInfo.setArtistsArray(artists)
				 .setName(name);
		return indexInfo;
	}
